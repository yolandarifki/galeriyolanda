 		...
 		<div class="row">
 			...
 			if (isset($_GET['albumid'])) {
 				...
 				while($data = mysqli_fetch_array($query)){ ?>
 					...
 					<div class="card">
 						<img src="../aseets/img/<?php echo $data['lokasifile'] ?>" class="card-img-top" title="<?php echo $data['lokasifile'] ?>" style="height:12rem;" >
 						<div class="card-footer text-center">
 							...
 							echo mysqli_num_rows($like). 'suka';
 							 ?>
 							<a href=""><i class="fa-regular fa-comment"></i></a>4 Komentar
 						</div>
 					</div>
 				</div>
